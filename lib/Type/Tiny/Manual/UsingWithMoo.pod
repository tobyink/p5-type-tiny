...
Type::Tiny is tested with L<Moo> 1.001000.
...
There is a patch in the Moo repository that will enable inlining to work
L<http://git.shadowcat.co.uk/gitweb/gitweb.cgi?p=gitmo/Moo.git;a=shortlog;h=refs/heads/coderef-overload>.
