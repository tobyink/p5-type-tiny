...
=head2 Notice: Planned Changes in Type::Tiny 3

Type::Tiny 3 is expected to be released in the second half of 2026. It is likely
to introduce coercions to some common type constraints such as B<HashRef>,
B<ArrayRef>, and B<Str>. If your code specifically relies on these types
not having coercions, you may need to change your code. (The C<no_coercions>
method can give you a copy of any type minus all coercions.)

Additional type constraints from L<Types::Common::Values> will be added to
L<Types::Common>.
...
=head2 Type::Tiny Security Policy

The L<latest stable release on CPAN|https://metacpan.org/release/Type-Tiny>
...
L<the Changes file on CPAN|https://metacpan.org/changes/distribution/Type-Tiny>
with security-related changes tagged "SECURITY" in capital letters.

=head3 Reporting a Vulnerability

Please report any issues via
L<GitHub Issues|https://github.com/tobyink/p5-type-tiny/issues>.
...
L<GitHub profile|https://github.com/tobyink>.
