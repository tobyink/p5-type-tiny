...
L<B>, L<B::Deparse>, L<Carp>, L<Data::Dumper>, L<Hash::Util::FieldHash>,
L<Scalar::Util>, L<Text::Balanced>, L<overload>, L<strict>, and L<warnings>.
All of these come bundled with Perl itself. Prior to Perl 5.10,
L<Hash::Util::FieldHash> was not included with Perl, so instead
L<Hash::Util::FieldHash::Compat> should be installed from the CPAN.
