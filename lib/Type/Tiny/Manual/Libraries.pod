...
Disclaimer: if your code breaks here when you upgrade from version 0.006 or below, saying that the 'extends' keyword has not been predeclared, just add '-all' after use Type::Utils.
