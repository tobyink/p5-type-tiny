...
Tests L<Eval::TypeTiny::CodeAccumulator> using the callback returned from
C<add_placeholder>.
...
my $ph_1 = $make_adder->add_placeholder( 'unpack-args' );
my $ph_2 = $make_adder->add_placeholder( 'dummy' );
$make_adder->add_gap;
$make_adder->add_line( 'return ' . $varname . ' + $other_addend;' );
$make_adder->decrease_indent;
$make_adder->add_line( '}' );

$ph_1->( 'my $other_addend = shift;' );
